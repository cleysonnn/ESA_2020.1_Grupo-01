...
import iconeMetaFinanceira from '../../assets/assets/iconeFinanceiro.png';
...
export default function MenuFinanceiroII() {
                ...
                <ScrollView style={styles.ScrollView}>
                    ...
                    <View style={styles.viewMid}>
                        <View style={styles.viewMidLeft}>
                            <Text style={styles.textMidLeft}>Quantia estimada</Text>
