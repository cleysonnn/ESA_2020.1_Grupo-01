...
import iconeMetaFinanceira from '../../assets/assets/iconeExercicio.png';
...
export default function MenuFinanceiroIII() {
            ...
            <SafeAreaView style={styles.container}>
                <ScrollView style={styles.ScrollView}>
                    ...
                    <View style={styles.viewInicial}>
                        ...
                        <Text style={styles.textFinanceira}>EXERCÍCIOS</Text>
